...
curl http://localhost:3000/api/backups -v
curl -X POST http://localhost:3000/api/backups -H 'Content-Type: application/json' -d '{"name":"new-backup"}'


curl http://localhost:3000/api/restores -v
curl -X POST http://localhost:3000/api/restores -H 'Content-Type: application/json' -d '{"name":"new-restore", "backup": "new-backup"}'


curl http://localhost:3000/api/schedules -v
curl -X POST http://localhost:3000/api/schedules -H 'Content-Type: application/json' -d '{"name":"new-schedule", "schedule": "0 1 * * 1,2,3,4,5,6"}'
